...
class Window(pyglet.window.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if button == pyglet.window.mouse.LEFT:  # Left mouse button pressed
            self.swing.gear2._set_phase(-self._theta *
                                        math.pi / 180 -
                                        1.2)  # Set legs to fully extend
            self.swing.gear1._set_phase(self._theta *
                                        math.pi / 180 +
                                        0.6)  # Set torso to fully retract
            print("Kicking forward")
        if button == pyglet.window.mouse.RIGHT:  # Right mouse button pressed
            self.swing.gear2._set_phase(-self._theta *
                                        math.pi / 180 +
                                        0.8)  # Set legs to fully retract
            self.swing.gear1._set_phase(self._theta *
                                        math.pi / 180 -
                                        0.2)  # Set torso to fully extend
    ...
    def update(self, dt):
        ...
        self.angle_history.append(self.swing.rod1._get_angle() *
                                  (180 / math.pi) - self._theta)  # Add angle to angle history
        self.angle = int(self.swing.rod1._get_angle() *
                         (180 / math.pi) - self._theta)  # Set current angle correctly
