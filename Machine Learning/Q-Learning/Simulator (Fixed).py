...
class Swing:
    ...
    def __init__(self, space: pymunk.Space, theta: int = 0):
        ...
        self.torso.position = (angle.point2[0] + angle.seat[1][0] +
                               (torso_length / 2) * math.sin(angle._theta), angle.point2[1] +
        ...
        self.legs.position = (angle.point2[0] + angle.seat[0][0] -
                              (legs_length / 2) * math.sin(angle._theta), angle.point2[1] +
        ...
        self.head.position = (angle.point2[0] + angle.seat[1][0] +
                              (torso_length - 10) * math.sin(angle._theta), angle.point2[1] +
        ...
        self.pivot5 = pymunk.PinJoint(self.rod1, self.seat, anchor_a=angle.rod1, anchor_b=angle.seat[0])
        self.pivot6 = pymunk.PinJoint(self.rod1, self.seat, anchor_a=angle.rod1, anchor_b=angle.seat[1])
        self.pivot7 = pymunk.PivotJoint(self.torso, self.seat, (angle.point2[0] + angle.seat[1][0], angle.point2[1] + angle.seat[1][1]))
        self.pivot8 = pymunk.PivotJoint(self.seat, self.legs, (angle.point2[0] + angle.seat[0][0], angle.point2[1] + angle.seat[0][1]))
