...
class NodeGene():
    ...
    def __init__(self, 
        ...
        if layer == 0: eff_layer = 0
        elif layer == 1: eff_layer = -1
    ...
    def add_connection(self, other, weight=0, innovation=None, activated=True):
        ...
        if self.layer == other.layer: print('Tried to connect two nodes in same layer.\n')
...
class Chromosome():
    ...
    def __init__(self, 
                 ...
                 connection_genes=None,         # ConnectionGene objects
                 node_genes=None,               # NodeGene objects
                 architecture=[],
                 input_size=None, 
                 output_size=None,
                 activation='sigmoid',              
