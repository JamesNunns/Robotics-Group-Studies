...
///<\summary>
{
	...
	void Start()
	{
		...
		low_cm.Add(rightElbow, Mathf.Rad2Deg*(1.356098f));
		low_cm.Add(rightShoulder, Mathf.Rad2Deg*(1.322266f));
		low_cm.Add(rightKnee, Mathf.Rad2Deg*(1.56f));
		low_cm.Add(rightAnkle, Mathf.Rad2Deg*(0.921976f));
		low_cm.Add(rightHip, Mathf.Rad2Deg*(-1.5708f));
		low_cm.Add(Neck, Mathf.Rad2Deg*(0.253068f));
