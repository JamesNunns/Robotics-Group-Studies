...
///<\summary>
{
	...
	void Start()
	{
		...
		low_cm.Add(leftElbow, Mathf.Rad2Deg*(1.356098f));
		low_cm.Add(leftShoulder, Mathf.Rad2Deg*(1.322266f));
		low_cm.Add(leftKnee, Mathf.Rad2Deg*(1.56f));
		low_cm.Add(leftAnkle, Mathf.Rad2Deg*(0.921976f));
		low_cm.Add(leftHip, Mathf.Rad2Deg*(-1.5708f));
	...
	}///TODO: Make a note of max crouch and extend values
	///Make crouch and extend smaller, particularly the neck angle
	///try and reinforce hinges of swing?
